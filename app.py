...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.btnCadastro = ctk.CTkButton(self.frameBtns, text='Cadastrar Veiculo', width=187, height=183, image=self.img_cad, compound='top', fg_color="#363D50", font=('Open Sans', 16, 'bold'), command=self.cadastro)
