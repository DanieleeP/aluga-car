...
class AlugarVeiculo(ctk.CTkToplevel):
    def __init__(self, master=None):
        ...
        self.labelPlaca = ctk.CTkLabel(self.frameItens, text='Placa', font=('Open Sans', 26, 'bold'))
        ...
        self.comboCliente = ctk.CTkComboBox(self.frameItens, font=('Open Sans', 16), width=300, state='disabled')
